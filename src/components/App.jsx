...
export const App = () => {
  ...
  const fetchData = async () => {
    const query = `https://pixabay.com/api/?q=${searchValue}&page=${currentPage}&key=43788826-a46fab3930d969eb04391cff8&image_type=photo&orientation=horizontal&per_page=12`;
    try {
